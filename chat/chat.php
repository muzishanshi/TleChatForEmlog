...
<header class="am-topbar am-topbar-inverse admin-header">
  <div class="am-topbar-brand">
	<?php $nickname=$userData['nickname']!=""?$userData['nickname']:$userData['username'];?>
    ...
    <div class="am-offcanvas-bar admin-offcanvas-bar">
      ...
      <div class="am-panel am-panel-default admin-sidebar-panel">
        <div class="am-panel-bd">
          ...
          <p><?=$config_app["notice"]?$config_app["notice"]:"时光静好，与君语；细水流年，与君同。";?></p>
        </div>
  ...
  <div class="admin-content">
    ...
    <footer class="admin-content-footer">
      <p class="am-padding-left">
		CopyRight©<?=date("Y");?> <a href="<?php echo BLOG_URL; ?>"><?php echo $blogname; ?></a> Powered by <a href="http://www.emlog.net/" title="Emlog" rel="nofollow">Emlog</a> Plugin By <a id="rightdetail" href="http://www.tongleer.com" title="同乐儿">Tongleer</a>
	  </p>
    </footer>
  </div>
  <!-- content end -->
...
<script src="<?=BLOG_URL;?>content/plugins/TleChat/chat/ui/js/amazeui.ie8polyfill.min.js"></script>
<![endif]-->
<script src="<?=BLOG_URL;?>content/plugins/TleChat/chat/ui/js/amazeui.min.js"></script>
